...
(function($){
	...
	THEMEVISION.header = {
        ...
        sticky: function( headerOffset ){
            var header = $('#masthead.header_v2, #masthead.header_v3'),
                dummy  = $('.agama-dummy-spacer'),
            ...
            if( $body.hasClass('device-md') || $body.hasClass('device-lg') ) {
                if( $( header ).length && ! $( dummy ).length ) {
                    $( header ).after('<div class="agama-dummy-spacer" style="width:1px; height:'+height+'px;display:none;"></div>');
                }
            }
		...
		Search: function() {
            if( agama_pro.header_search == true ) {
                ...
                if( $body.hasClass( 'device-sm') || $body.hasClass( 'device-xs') ) {
                    var top = $('.mobile-menu-icons').height();
                }
                
                $('.vision-search-box').css('top', top);
                $('.top-search-trigger').on('click', function() {
                    $(this).toggleClass('active')
                           .next('.vision-search-box')
                           .toggleClass('active');
                });
            }
		},
	...
	THEMEVISION.documentOnReady = {
		...
		windowscroll: function(){
			...
			$window.on( 'scroll', function(){
                ...
                if( $( '#masthead.header_v2, #masthead.header_v3').length ) {
