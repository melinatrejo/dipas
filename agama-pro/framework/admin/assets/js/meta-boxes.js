...
jQuery(function($){
  ...
  var frame,
      metaBox = $('#agama_options_metabox.postbox'), // Your meta box id here
      addImgLink = metaBox.find('.agama-upload-header-image'),
      delImgLink = metaBox.find('.agama-delete-header-image'),
      imgContainer = metaBox.find('.agama_header_image_container'),
      imgIdInput = metaBox.find('.agama-header-image');
...
jQuery(function($){
  ...
  var frame,
      metaBox = $('#agama_options_metabox.postbox'), // Your meta box id here
      addImgLink = metaBox.find('.agama-upload-page-bg-img'),
      delImgLink = metaBox.find('.agama-delete-page-bg-img'),
      imgContainer = metaBox.find('.agama_page_bg_img_container'),
      imgIdInput = metaBox.find('.agama-page-bg-img');
