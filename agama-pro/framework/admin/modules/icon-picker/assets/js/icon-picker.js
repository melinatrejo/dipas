...
(function($) {
	...
	function build_list($popup,$button,clear) {
	  $list = $popup.find('.agama-icon-picker-list');
	  ...
	  for (var i in icons) {
		  $list.append('<li data-icon="'+icons[i]+'"><a href="#" title="'+icons[i]+'"><span class="'+options[0]+' '+options[1]+'-'+icons[i]+'"></span></a></li>');
				...
				$('a', $list).click(function(e) {
					...
					$button.removeClass().addClass("button agama-icon-picker "+options[0]+" "+options[1]+"-"+title);
			...
			function removePopup(){
				$(".agama-icon-picker-container").remove();
			}
	
			$button = $('.agama-icon-picker');
			...
			function createPopup($button) {
				...
				$popup = $('<div class="agama-icon-picker-container"> \
						<div class="agama-icon-picker-control" /> \
						<ul class="agama-icon-picker-list" /> \
					</div>')
					.css({
				...
				var $control = $popup.find('.agama-icon-picker-control');
