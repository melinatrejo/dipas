...
class Agama_Partial_Refresh {
    ...
    public static function preview_nav_search_icon() {
        ...
        if( $search ) {
            $output = '<i class="fa fa-search">';
        }
        return $output;
    }
    
    #########################
    # PREVIEW LOGO DESKTOP
    #########################
    public static function preview_desktop_logo() {
        $output  = '';
        $desktop = get_theme_mod( 'agama_logo' );
        $mobile  = get_theme_mod( 'agama_mobile_logo' );
        
        // If desktop logo uploaded.
        if( ! empty( $desktop ) ) {
            $output .= '<img src="'. esc_url( $desktop ) .'" class="logo logo-desktop">';
        }
        
        // If mobile logo uploaded.
        if( ! empty( $mobile ) ) {
            $output .= '<img src="'. esc_url( $mobile ) .'" class="logo logo-mobile">';
        }
        
        // If desktop and mobile logos not uploaded.
    ...
    # PREVIEW LOGO MOBILE
    #########################
    public static function preview_mobile_logo() {
        $output  = '';
        $desktop = get_theme_mod( 'agama_logo' );
        $mobile  = get_theme_mod( 'agama_mobile_logo' );
    ...
    # SHARE ICONS
    ############################################
    public static function preview_share_box() {
