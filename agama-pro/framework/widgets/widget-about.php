...
class Agama_Widget_About extends WP_Widget {
	...
	public function widget( $args, $instance ) {
        ...
        echo $before_widget;
            ...
            echo '<div class="about-inner-wrapper">';
                ...
                if( is_page_template( 'templates/for-page-builders.php' ) || is_page_template( 'templates/full-width.php' ) ) {
    ...
    public function inline_css() {
        ...
        foreach ( $settings as $instance_id => $instance ) {
            ...
            if( ! empty( $content_bg ) ||  ! empty( $title_color ) || ! empty( $content_color ) ) {
                wp_add_inline_style( 'agama-pro-style', $widget_style );
            }
        }
