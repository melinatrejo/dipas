	...
	class Vision_Flickr_Widget extends WP_Widget {
		...
		function __construct() {
            ...
            if( is_customize_preview() ) {
                $widgetName = esc_attr__( 'Flickr', 'agama-pro' );
            } else {
                $widgetName = esc_attr__( 'Agama: Flickr', 'agama-pro' );
            }
            
			parent::__construct( 'agama_widget_flickr', $widgetName, array( 
                'classname' => 'agama-widget-flickr agama-widget flickr', 
                'description' => esc_attr__( 'The most recent photos from flickr.', 'agama-pro' ),
