	...
	class Vision_Facebook_Like_Widget extends WP_Widget {
		...
		function __construct() {
            ...
            if( is_customize_preview() ) {
                $widgetName = esc_attr__( 'Facebook Like Box', 'agama-pro' );
            } else {
                $widgetName = esc_attr__( 'Agama: Facebook Like Box', 'agama-pro' );
            }
            
			parent::__construct( 'agama_widget_facebook_like_box', $widgetName, array( 
                'classname' => 'agama-widget-facebook-like-box agama-widget facebook_like', 
		...
		function widget( $args, $instance )
		{
			...
			$widget_width 	= isset( $instance['width'] ) ? esc_attr( $instance['width'] ) : '';
		...
		{
			$defaults = array(
				'title' 		=> esc_html__( 'Find us on Facebook', 'agama-pro' ),
				'app_id' 		=> '', 
				'page_url' 		=> '', 
				'width' 		=> '275',
				'adapt_width'	=> true,
