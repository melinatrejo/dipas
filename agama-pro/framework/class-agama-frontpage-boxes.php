...
class Front_Page_Boxes {
	...
	private static function get_options() {
        ...
        $boxes['heading'] = esc_html( get_theme_mod( 'agama_frontpage_boxes_heading', '' ) );
			...
			echo '<div id="frontpage-boxes" class="clearfix">';
				...
				if( $box[1]['enabled'] ) {
					...
					echo '<div class="'. $boxes['1-4']['class'] .' fbox-1"'. $box[1]['data_animate'].$box[1]['data_delay'].'>';
						...
						if( $box[1]['title'] ) {
							echo '<h2>'; Helper::pll_e( $box[1]['title'] ); echo '</h2>';
						}
						if( $box[1]['desc'] ) {
							echo '<p>'; Helper::pll_e( $box[1]['desc'] ); echo '</p>';
						}
						if( $box[1]['readmore'] ) {
                            if( is_customize_preview() ) {
							...
							echo '<a href="'. $box[1]['readmore_url'] .'" class="button button-small button-rounded button-reveal button-border tright">';
								...
								echo '<span>'; Helper::pll_e( $box[1]['readmore_title'] ); echo '</span>';
							echo '</a>';
                            if( is_customize_preview() ) {
                                echo '</span>';   
                            }
				...
				if( $box[2]['enabled'] ) {
					...
					echo '<div class="'. $boxes['1-4']['class'] .' fbox-2"'. $box[2]['data_animate'].$box[2]['data_delay'].'>';
						...
						if( $box[2]['title'] ) {
							echo '<h2>'; Helper::pll_e( $box[2]['title'] ); echo '</h2>';
						}
						if( $box[2]['desc'] ) {
							echo '<p>'; Helper::pll_e( $box[2]['desc'] ); echo '</p>';
						}
						if( $box[2]['readmore'] ) {
                            if( is_customize_preview() ) {
                                echo '<span class="vision-fbox-button vision-preview">';
							...
							echo '<a href="'. $box[2]['readmore_url'] .'" class="button button-small button-rounded button-reveal button-border tright">';
								echo '<i class="fa fa-link"></i> ';
								echo '<span>'; Helper::pll_e( $box[2]['readmore_title'] ); echo '</span>';
							echo '</a>';
                            if( is_customize_preview() ) {
                                echo '</span>';
                            }
				...
				if( $box[3]['enabled'] ) {
					...
					echo '<div class="'. $boxes['1-4']['class'] .' fbox-3"'. $box[3]['data_animate'].$box[3]['data_delay'].'>';
						...
						if( $box[3]['title'] ) {
							echo '<h2>'; Helper::pll_e( $box[3]['title'] ); echo '</h2>';
						}
						if( $box[3]['desc'] ) {
							echo '<p>'; Helper::pll_e( $box[3]['desc'] ); echo '</p>';
						}
						if( $box[3]['readmore'] ) {
                            if( is_customize_preview() ) {
                                echo '<span class="vision-fbox-button vision-preview">';
							...
							echo '<a href="'. $box[3]['readmore_url'] .'" class="button button-small button-rounded button-reveal button-border tright">';
								echo '<i class="fa fa-link"></i> ';
								echo '<span>'; Helper::pll_e( $box[3]['readmore_title'] ); echo '</span>';
							echo '</a>';
                            if( is_customize_preview() ) {
                                echo '</span>';
                            }
				...
				if( $box[4]['enabled'] ) {
					...
					echo '<div class="'. $boxes['1-4']['class'] .' fbox-4"'. $box[4]['data_animate'].$box[4]['data_delay'].'>';
						...
						if( $box[4]['title'] ) {
							echo '<h2>'; Helper::pll_e( $box[4]['title'] ); echo '</h2>';
						}
						if( $box[4]['desc'] ) {
							echo '<p>'; Helper::pll_e( $box[4]['desc'] ); echo '</p>';
						}
						if( $box[4]['readmore'] ) {
                            if( is_customize_preview() ) {
                                echo '<span class="vision-fbox-button vision-preview">';
							...
							echo '<a href="'. $box[4]['readmore_url'] .'" class="button button-small button-rounded button-reveal button-border tright">';
								echo '<i class="fa fa-link"></i> ';
								echo '<span>'; Helper::pll_e( $box[4]['readmore_title'] ); echo '</span>';
							echo '</a>';
                            if( is_customize_preview() ) {
                                echo '</span>';
                            }
				...
				if( $box[5]['enabled'] ) {
					...
					echo '<div class="'. $boxes['5-8']['class'] .' fbox-5"'. $box[5]['data_animate'].$box[5]['data_delay'].'>';
						...
						if( $box[5]['title'] ) {
							echo '<h2>'; Helper::pll_e( $box[5]['title'] ); echo '</h2>';
						}
						if( $box[5]['desc'] ) {
							echo '<p>'; Helper::pll_e( $box[5]['desc'] ); echo '</p>';
						}
						if( $box[5]['readmore'] ) {
                            if( is_customize_preview() ) {
                                echo '<span class="vision-fbox-button vision-preview">';
							...
							echo '<a href="'. $box[5]['readmore_url'] .'" class="button button-small button-rounded button-reveal button-border tright">';
								echo '<i class="fa fa-link"></i> ';
								echo '<span>'; Helper::pll_e( $box[5]['readmore_title'] ); echo '</span>';
							echo '</a>';
                            if( is_customize_preview() ) {
                                echo '</span>';
                            }
				...
				if( $box[6]['enabled'] ) {
					...
					echo '<div class="'. $boxes['5-8']['class'] .' fbox-6"'. $box[6]['data_animate'].$box[6]['data_delay'].'>';
						...
						if( $box[6]['title'] ) {
							echo '<h2>'; Helper::pll_e( $box[6]['title'] ); echo '</h2>';
						}
						if( $box[6]['desc'] ) {
							echo '<p>'; Helper::pll_e( $box[6]['desc'] ); echo '</p>';
						}
						if( $box[6]['readmore'] ) {
                            if( is_customize_preview() ) {
                                echo '<span class="vision-fbox-button vision-preview">';
							...
							echo '<a href="'. $box[6]['readmore_url'] .'" class="button button-small button-rounded button-reveal button-border tright">';
								echo '<i class="fa fa-link"></i> ';
								echo '<span>'; Helper::pll_e( $box[6]['readmore_title'] ); echo '</span>';
							echo '</a>';
                            if( is_customize_preview() ) {
                                echo '</span>';
                            }
				...
				if( $box[7]['enabled'] ) {
					...
					echo '<div class="'. $boxes['5-8']['class'] .' fbox-7"'. $box[7]['data_animate'].$box[7]['data_delay'].'>';
						...
						if( $box[7]['title'] ) {
							echo '<h2>'; Helper::pll_e( $box[7]['title'] ); echo '</h2>';
						}
						if( $box[7]['desc'] ) {
							echo '<p>'; Helper::pll_e( $box[7]['desc'] ); echo '</p>';
						}
						if( $box[7]['readmore'] ) {
                            if( is_customize_preview() ) {
                                echo '<span class="vision-fbox-button vision-preview">';
							...
							echo '<a href="'. $box[7]['readmore_url'] .'" class="button button-small button-rounded button-reveal button-border tright">';
								echo '<i class="fa fa-link"></i> ';
								echo '<span>'; Helper::pll_e( $box[7]['readmore_title'] ); echo '</span>';
							echo '</a>';
                            if( is_customize_preview() ) {
                                echo '</span>';
                            }
				...
				if( $box[8]['enabled'] ) {
					...
					echo '<div class="'. $boxes['5-8']['class'] .' fbox-8"'. $box[8]['data_animate'].$box[8]['data_delay'].'>';
						...
						if( $box[8]['title'] ) {
							echo '<h2>'; Helper::pll_e( $box[8]['title'] ); echo '</h2>';
						}
						if( $box[8]['desc'] ) {
							echo '<p>'; Helper::pll_e( $box[8]['desc'] ); echo '</p>';
						}
						if( $box[8]['readmore'] ) {
                            if( is_customize_preview() ) {
                                echo '<span class="vision-fbox-button vision-preview">';
							...
							echo '<a href="'. $box[8]['readmore_url'] .'" class="button button-small button-rounded button-reveal button-border tright">';
								echo '<i class="fa fa-link"></i> ';
								echo '<span>'; Helper::pll_e( $box[8]['readmore_title'] ); echo '</span>';
							echo '</a>';
                            if( is_customize_preview() ) {
                                echo '</span>';
                            }
...
add_action( 'wp_head', [ __NAMESPACE__ . '\Front_Page_Boxes', 'hook_css' ] );
